...
This update contains fixes that were issued after the release of SQL Server 2022 Cumulative Update 23, and it updates components in the following builds:
